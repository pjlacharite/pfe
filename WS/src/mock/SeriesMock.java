...
public class SeriesMock {
    ...
    public static List<Serie> mockSeries(){
        ...
        Serie serie1 = new Serie("1", SeasonMock.lazyMockSeasons().size(), "How I Met Your Mother", "The series revolves around Ted Mosby narrating the story of how he met his wife to his children.");
        Serie serie2 = new Serie("2", SeasonMock.lazyMockSeasons().size(), "The Big Bang Theory", "The Big Bang Theory is centered on physicists Sheldon Cooper and Leonard Hofstadter, whose geeky and introverted lives are changed when Penny, an attractive waitress and aspiring actress, moves into the apartment across from theirs.");
        Serie serie3 = new Serie("3", SeasonMock.lazyMockSeasons().size(), "Californication", "David Duchovny is the lead in this comedy about a book writer always running into trouble with sex, drugs and women, while struggling to maintain a relationship with his ex-girlfriend and trying to raise his daughter in a less than normal environment for a teenager.");
